...
export default function DropDown({ setPage, setSortBy, setOrder }) {
  ...
  return (
    <Menu as="div" className="relative inline-block">
      <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-black inset-ring-1 inset-ring-white/5 hover:bg-gray-200/10 cursor-pointer">
        Sort By
        <ChevronDownIcon
          aria-hidden="true"
